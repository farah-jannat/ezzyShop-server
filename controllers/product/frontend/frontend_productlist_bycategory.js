...
const frontend_productlist_bycategory = async (req, res) => {
  const {
    none,
    page,
    max_price,
  ...
  try {
    ...
    console.log("this is totalcoountbefore filer", totalCountBeforeFilter);
    ...
    console.log("this is data :", productsBeforeFilter);
...
module.exports = frontend_productlist_bycategory;
