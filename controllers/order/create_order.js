...
const website_info = require("../../models/website_info.js");
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tbody>
                                <tr>
                                    ...
                                    <td width="50%" align="right" style="border-bottom: 1px solid #eee; padding: 8px; font-family: Arial, Helvetica, sans-serif; font-size: 12px;"><strong>Invoice No.: ${
                                      savedOrder.orderid
                                    }</strong></td>
                                </tr>
                                <tr>
                                    <td width="50%" valign="top" style="border-bottom: 1px solid #eee; border-right: 1px solid #eee; padding: 8px; line-height: 20px; font-family: Arial, Helvetica, sans-serif; font-size: 12px;">
                                        <p>
                                            <strong>Name:</strong> ${
                                              savedOrder.shipping_first_name
                                            }&nbsp;${
      savedOrder.shipping_last_name
    }<br>
                                            <strong>Address:</strong> ${
                                              savedOrder.shipping_address1
                                            },${savedOrder.shipping_address2},${
      savedOrder.shipping_city
    },${savedOrder.shipping_state},${savedOrder.shipping_country}-${
      savedOrder.shipping_pincode
    }<br>
                                            <strong>Phone no.: </strong>${
                                              savedOrder.shipping_mobile
                                            }<br>
                                            <strong>Email: </strong>${
                                              savedOrder.shipping_email
                                            }
                                        </p>
                                    </td>
                            ...
                            <tbody>
                                ...
                                ${existingCartItem.map(
                                  ...
                                  <td style={{ borderBottom: '1px solid black', borderRight: '1px solid black', fontFamily: 'Arial, Helvetica, sans-serif', fontSize: '12px' }} width="12%" align="center">&nbsp;${
                                    rescart.product_id == null
                                      ? rescart.product_variant_id.selling_price
                                      : rescart.product_id.selling_price
                                  }</td>
                                  <td style={{ borderBottom: '1px solid black', fontFamily: 'Arial, Helvetica, sans-serif', fontSize: '12px' }} width="12%" align="center">&nbsp;${
                                    rescart.product_id == null
                                      ? rescart.product_variant_id
                                          .selling_price * rescart.product_qty
                                      : rescart.product_id.selling_price *
                                        rescart.product_qty
                                  }</td>
                                </tr>`
                                ...
                                <tr>
                                    ...
                                    <td colspan="3" style="border-bottom: 1px solid #eee; font-family: Arial, Helvetica, sans-serif; background: #CCC; font-size: 14px; font-weight: bold;" width="15%" align="center">${
                                      savedOrder.sub_total_amount
                                    }</td>
                                </tr>
                            </tbody>
                        </table>
